        ...
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header"> 
                    Editar Procedimento 
                    <i title="Por motivo de integridade não é possível editar os dados do procedimento" style="cursor:help" class="zmdi zmdi-help-outline zmdi-hc-fw text-danger"> </i> 
                </h5>
