<div class="card-body">
    ...
    <div class="form-body">
        ...
        <div class="form-group row {{ $errors->has('cep') ? 'has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input name="cep" value="{{$radiologista->cep ?? old('cep') }}" type="text" class="form-control cepMask" placeholder="00000-00">
                @if ($errors->has('cep')) 
                ...
                <select id="estado" name="estado" value="{{ old('estado') }}" class="form-control">
                    ...
                    @if ($estados)
                        @foreach($estados as $estado)
                            @if(isset($radiologista->fk_estado) && $radiologista->fk_estado == $estado->id)
        ...
        <div class="form-group row {{ $errors->has('logradouro') ? 'has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input name="logradouro" value="{{$radiologista->logradouro ?? old('logradouro') }}" type="text" class="form-control">
        ...
        <div class="form-group row {{ $errors->has('numero') ? 'has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input name="numero" value="{{$radiologista->numero ?? old('numero') }}" type="text" class="form-control">
        ...
        <div class="form-group row {{ $errors->has('bairro') ? 'has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input name="bairro" value="{{$radiologista->bairro ?? old('bairro') }}" type="text" class="form-control">
        ...
        <div class="form-group row {{ $errors->has('complemento') ? 'has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input name="complemento" value="{{$radiologista->complemento ?? old('complemento') }}" type="text" class="form-control">
