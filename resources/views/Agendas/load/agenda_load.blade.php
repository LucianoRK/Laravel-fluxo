...
<div class="row mb-2 agenda_linha">
    <div class="input-group col-md-8 agenda_campos">
        <span class="input-group-text text-white bg-primary horario"><strong>{{ $agenda['hora'] }}</strong></span>
        <div class="form-control select_cliente_busca"></div>
        <button type="button" class="form-control text-left agenda_mostrar agenda_mostrar_nome bg-white">{{ $agenda['nome_cliente'] }} </button>
